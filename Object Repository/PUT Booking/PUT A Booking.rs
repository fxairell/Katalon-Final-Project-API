...
<WebServiceRequestEntity>
   <description>PUT Method to update a booking with valid credential</description>
   <name>PUT A Booking</name>
   <tag></tag>
   <elementGuidId>59006719-5bf1-4612-b19b-d7bbc66b8252</elementGuidId>
...
WS.verifyElementPropertyValue(response, 'bookingdates.checkout', '2025-01-01')
WS.verifyElementPropertyValue(response, 'additionalneeds', 'All You Can Do')</verificationScript>
