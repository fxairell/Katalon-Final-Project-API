...
<WebServiceRequestEntity>
   <description>PUT Method to update a booking with valid credential without Check Out</description>
   <name>PUT A Booking (Without Check Out)</name>
   <tag></tag>
   <elementGuidId>b5bf584d-dcb2-42f9-9139-ad88ba8fb192</elementGuidId>
...
// Bad Request because there is no Check Out
