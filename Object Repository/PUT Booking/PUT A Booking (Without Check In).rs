...
<WebServiceRequestEntity>
   <description>PUT Method to update a booking with valid credential without Check In</description>
   <name>PUT A Booking (Without Check In)</name>
   <tag></tag>
   <elementGuidId>0d46af69-e028-4af7-8d62-c404d30286a3</elementGuidId>
...
// Bad Request because there is no Check In
