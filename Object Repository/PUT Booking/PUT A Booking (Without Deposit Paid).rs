...
<WebServiceRequestEntity>
   <description>PUT Method to update a booking with valid credential without Deposit Paid</description>
   <name>PUT A Booking (Without Deposit Paid)</name>
   <tag></tag>
   <elementGuidId>bd9ddbbd-a562-48cf-aafe-8361f9375da8</elementGuidId>
...
// Bad Request because there is no Deposit Paid
