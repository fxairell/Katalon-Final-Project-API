...
<WebServiceRequestEntity>
   <description>POST Method to post a booking</description>
   <name>POST A Booking</name>
   <tag></tag>
   <elementGuidId>294bd0f8-045c-4ae0-ba7d-df4c86f5cbc1</elementGuidId>
...
WS.verifyElementPropertyValue(response, 'booking.bookingdates.checkout', '2023-01-01')
WS.verifyElementPropertyValue(response, 'booking.additionalneeds', 'All Services')

// Pass along Booking ID value into Global Variable
GlobalVariable.booking_id = WS.getElementPropertyValue(response, 'bookingid')</verificationScript>
