...
<WebServiceRequestEntity>
   <description>POST Method to post a booking without Check Out</description>
   <name>POST A Booking (Without Check Out)</name>
   <tag></tag>
   <elementGuidId>fed8e9fb-6874-4cf6-8dfb-a3ce04bb3dbe</elementGuidId>
...
// Internal Server Error because there is no Check Out
